...
cd ~ && mkdir mnt
aria2c -x 4 -s 4  https://dietpi.com/downloads/images/DietPi_RPi-ARMv6-Bullseye.7z
p7zip -d DietPi_RPi-ARMv6-Bullseye.7z

fdisk -l DietPi_RPi-ARMv6-Bullseye.img
...
# root tarball
mount -o loop,ro,offset=$((270336*512)) DietPi_RPi-ARMv6-Bullseye.img mnt
